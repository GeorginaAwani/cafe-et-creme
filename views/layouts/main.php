	...
	<div class="container-fluid h-100">
		<div class="row h-100">
			<aside class="col-lg-3 px-0" id="sideNav">
				<nav class="bg-primary border-2 border-end h-100 navbar sticky-top navbar-dark navbar-expand-lg px-lg-5 py-lg-4" id="mainNavbar">
					<div class="h-100 d-flex flex-lg-column px-3 px-lg-0 justify-content-between justify-content-lg-start w-100">
						...
						<div class="offcanvas offcanvas-end flex-column" tabindex="-1" id="offcanvasNavbar" aria-labelledby="siteName">
							...
							<div class="offcanvas-body flex-grow-1" id="mainNavbarNav">
...
<script>
	$(function() {
		$(`#mainNavbarNav .nav-link[href="${location.pathname}"]`).addClass('active').attr('aria-cuurent', 'page')
	})
</script>
