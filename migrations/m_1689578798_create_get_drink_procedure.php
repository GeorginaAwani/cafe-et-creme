...
class m_1689578798_create_get_drink_procedure extends Migration
{
	public function up()
	{
		$this->db->exec("CREATE PROCEDURE GetDrinkAgainstCart(IN cartId INT, IN drinkId INT)
		BEGIN
			SET @query = '
			...
			EXECUTE stmt USING cartId, cartId, drinkId;
	...
	{
		$this->db->exec('DROP PROCEDURE [IF EXISTS] GetDrinkAgainstCart');
	}
}
